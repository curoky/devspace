...
# Build PyTorch (torch/torchvision/torchaudio) from source for 8x H100 (SM 9.0)
# against CUDA 12.9, from the repo root. Produces
# ghcr.io/curoky/devspace:deps-torch2.13-cu12.9.1-cudnn9-gcc12-py3.12.
...
docker build . --network=host \
  ...
  --file "images/deps/pytorch/${combo}.Dockerfile" \
