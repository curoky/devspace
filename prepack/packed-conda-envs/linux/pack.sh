...
makeself --complevel 6 --tar-quietly --gzip --threads 16 /home/x/app/conda tmp/conda-envs.linux-x86_64.gzip.sh "Conda Installer" ./installer.sh
makeself --complevel 16 --tar-quietly --zstd --threads 16 /home/x/app/conda tmp/conda-envs.linux-x86_64.zstd.sh "Conda Installer" ./installer.sh
