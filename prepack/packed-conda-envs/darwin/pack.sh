...
makeself --complevel 6 --tar-quietly --gzip --threads 16 /Users/x/app/conda tmp/conda-envs-installer.darwin-arm64.gzip.sh "Conda Installer" ./installer.sh
makeself --complevel 16 --tar-quietly --zstd --threads 16 /Users/x/app/conda tmp/conda-envs-installer.darwin-arm64.zstd.sh "Conda Installer" ./installer.sh
