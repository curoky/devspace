...
def register_deploy_key(token: str, repo: str, cs_id: str, public_openssh: str) -> int:
    """Register ``public_openssh`` as a read-write deploy key; return its id.

    The key is titled ``codespace-<cs_id>`` so it can later be rediscovered by
    title. The caller registers the public half generated by the agent.
    """
