...
def service(
    ...
    monkeypatch.setattr(ssh, "reset_control_state", lambda *args: None)
    monkeypatch.setattr(ssh, "signal_provider_ready", lambda *args: None)
...
def test_create_runs_all_stages_in_order(
    ...
    monkeypatch.setattr(ssh, "signal_provider_ready", lambda *args: events.append("provider-ready"))
